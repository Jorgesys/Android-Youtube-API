...
public class StandalonePlayerDemoActivity extends Activity implements View.OnClickListener {
  ...
  private static final String VIDEO_ID = "_7I1sjCdB_I";
  private static final String PLAYLIST_ID =  "PL2E4BB0D8399151C4";
  private static final ArrayList<String> VIDEO_IDS = new ArrayList<String>(Arrays.asList(
      new String[] {"vkUpfw4Hf3w", "_7I1sjCdB_I", "9IrWyZ0KZuk"}));
  ...
  public void onClick(View v) {
    ...
    if (v == playVideoButton) {
      intent = YouTubeStandalonePlayer.createVideoIntent(
          this, YOUTUBE_API_KEY, VIDEO_ID, startTimeMillis, autoplay, lightboxMode);
    } else if (v == playPlaylistButton) {
      intent = YouTubeStandalonePlayer.createPlaylistIntent(this, YOUTUBE_API_KEY,
          PLAYLIST_ID, startIndex, startTimeMillis, autoplay, lightboxMode);
    } else if (v == playVideoListButton) {
      intent = YouTubeStandalonePlayer.createVideosIntent(this, YOUTUBE_API_KEY,
